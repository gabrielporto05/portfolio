    ...
    <main className="flex flex-col items-center px-6 py-16 md:py-24 max-w-6xl mx-auto">
      ...
      <section id="about" className="w-full max-w-3xl mx-auto mb-24">
        ...
        <p className="text-muted-foreground leading-relaxed text-center">
          Formado pelo IFNMG, desenvolvo soluções web e mobile com foco em
          código limpo e experiências de usuário bem fundamentadas. Atualmente
          colaboro em projetos institucionais pelo IFNMG, como Desenvolvedor de
          Software. Valorizo trabalhos colaborativos, boas práticas e
      ...
      <section id="contact" className="w-full text-center">
        ...
        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
          Estou disponível para oportunidades, projetos freelance ou apenas para
