    ...
    <main className="flex flex-col items-center px-6 py-16 md:py-24 max-w-6xl mx-auto">
      <section className="w-full text-center mb-20">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          Da formação técnica aos desafios profissionais, cada linha de código
          escrita conta parte da minha história.
        </p>
      </section>
      ...
      <section className="w-full mb-24 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="flex-1">
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Me chamo <strong>Gabriel Martins Moraes Porto</strong>, tenho 19
              anos e sou um desenvolvedor Web & Mobile com foco em
              desenvolvimento Front End. Gosto de trabalhar com tecnologias
              modernas e construir interfaces funcionais, bem organizadas e com
              atenção à performance.
            </p>
            <p>
              Iniciei minha trajetória técnica durante o curso de Informática no
              ensino médio (EE Tancredo Neves, 2021–2023), e atualmente curso{" "}
              <strong>Análise e Desenvolvimento de Sistemas</strong> no IFNMG.
              Com isso, venho consolidando conhecimentos práticos e acadêmicos
              em desenvolvimento web.
            </p>
            <p>
              Desde agosto de 2024, atuo como desenvolvedor na{" "}
              <strong>plataforma Pharus – Gestão de Eventos</strong>, onde sou
              responsável por entregar soluções front-end com Next.js,
              TypeScript e integrações com APIs. Também desenvolvo projetos
              pessoais e freelances voltados para interfaces responsivas e boas
              práticas de código.
            </p>
            <p>
              Prezo por consistência, clareza na estruturação do projeto,
              versionamento limpo e entregas bem documentadas — sempre com foco
              em propósito real e experiência do usuário.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
          Se você busca um desenvolvedor Front End comprometido, profissional,
          em busca de crescimento e aprendizado, estou aqui para ajudar.
        </p>
